...
func main() {
	fmt.Println("=================================================================================")
	fmt.Println("MCP Go Client Example (SSE Transport)")
	fmt.Println("=================================================================================")
	fmt.Println("This example demonstrates connecting a Go client to an MCP server via SSE")
	fmt.Println()
	...
	transport := sse.NewClientTransport(
		serverURL,
	...
	echoArgs := map[string]interface{}{
		"message": "Hello from Go SSE client!",
	}
